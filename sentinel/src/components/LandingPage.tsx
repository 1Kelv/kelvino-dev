      ...
      <main className="landing-main">
        <div className="landing-hero">
          ...
          <p className="hero-description">
            ...
            and guides agents with intelligent prompts — so the right support reaches customers at the
        ...
        <div className="confidence-legend">
          <div className="legend-item">
            <span className="legend-dot monitor-dot" />
            <span className="legend-label">20–49% Monitor</span>
          </div>
          <div className="legend-divider" />
          <div className="legend-item">
            <span className="legend-dot soft-dot" />
            <span className="legend-label">50–74% Soft Prompt</span>
          </div>
          <div className="legend-divider" />
          <div className="legend-item">
            <span className="legend-dot hard-dot" />
            <span className="legend-label">75%+ Hard Alert</span>
          </div>
        </div>

        <div className="compliance-bar">
          <span>FCA Consumer Duty</span>
          <span>UK GDPR</span>
          <span>Human-in-the-loop</span>
          <span>Data Minimisation</span>
          <span>Fairness Monitored</span>
          <span>Agent empowerment — not replacement</span>
        </div>
      </main>
    </div>
  );
